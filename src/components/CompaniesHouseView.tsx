            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className={`rounded-lg p-4 border ${accountsUrgency.bg} ${accountsUrgency.border}`}>
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-full ${accountsUrgency.badge} flex items-center justify-center`}>
                ...
                <div className={`rounded-lg p-4 border ${confirmationUrgency.bg} ${confirmationUrgency.border}`}>
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-full ${confirmationUrgency.badge} flex items-center justify-center`}>
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
